...
class ClienteIndicadoItem extends StatelessWidget {
  final ClienteIndicado clienteIndicado;

  const ClienteIndicadoItem(
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      leading: CircleAvatar(
        backgroundImage: NetworkImage(clienteIndicado.imageUrl),
      ),
              ...
              onPressed: () {
                showDialog<bool>(
                  ...
                  builder: (ctx) => AlertDialog(
                    title: const Text('Excluir indicação'),
                  ...
                  if (value ?? false) {
                    try {
                      await Provider.of<ClienteIndicadoList>(
                        context,
                        listen: false,
                      ).removeClienteIndicado(clienteIndicado);
